...
# renovate:github-url
python3 openapi2jsonschema.py https://raw.githubusercontent.com/traefik/traefik/v3.6.0/docs/content/reference/dynamic-configuration/kubernetes-crd-definition-v1.yml
...
helm template --include-crds --repo https://victoriametrics.github.io/helm-charts/ --set settings.clusterName=test victoria-metrics-k8s-stack --version "0.63.5" > crd.yaml
python3 openapi2jsonschema.py crd.yaml && rm crd.yaml
