...
# renovate:github-url
kustomize build https://github.com/argoproj/argo-workflows//manifests/base/crds/full?ref=v3.7.11 > crd.yaml
...
helm template --include-crds --repo https://victoriametrics.github.io/helm-charts/ --set settings.clusterName=test victoria-metrics-k8s-stack --version "0.72.4" > crd.yaml
python3 openapi2jsonschema.py crd.yaml && rm crd.yaml
