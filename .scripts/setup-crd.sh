...
helm template --include-crds --repo https://prometheus-community.github.io/helm-charts --set settings.clusterName=test prometheus-operator-crds --version "28.0.1" > crd.yaml
python3 openapi2jsonschema.py crd.yaml && rm crd.yaml
...
helm template --include-crds --repo https://victoriametrics.github.io/helm-charts/ --set settings.clusterName=test victoria-metrics-k8s-stack --version "0.72.5" > crd.yaml
python3 openapi2jsonschema.py crd.yaml && rm crd.yaml
