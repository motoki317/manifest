...
# renovate:github-url
python3 openapi2jsonschema.py https://raw.githubusercontent.com/traefik/traefik/v3.2.4/docs/content/reference/dynamic-configuration/kubernetes-crd-definition-v1.yml
